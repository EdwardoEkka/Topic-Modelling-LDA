...
stop_words = [    'for', 'couldn', 'hers', 'so', 'myself', 'themselves', 'each',
    ...
    'that', 'as', 'below', 'off', 'not', 'mustn', 'before''news', 'live', 'tak', 'at2', 'aajtak', 'updates', 'or', 'aaj',
              'viralvideo', 'shorts', 'and39', 'new', 'row', 'viral', 'latest', 'the', 'shortsvideo', 'up', 'of', 'top'
                 ,'pakistan','black','white','modi','bjp','pm','congress','headlines','and','breaking','cm'                                                                                                 'tv'
              'sudhir', 'chaudhary','cm','police','tv']
...
with open('aajtk_model.json', 'w', encoding='utf-8') as json_file:
